  ...
  return (
    <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:gap-6">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-2">
        ...
        <p className="text-lg text-muted-foreground sm:text-[1.15rem] sm:leading-tight md:text-[1.25rem]">{experience.roleTitle}</p>
        {authorLabel && (
          <p className="text-lg text-muted-foreground sm:text-[0.9rem] sm:leading-tight flex items-center gap-1">
        ...
        <div className="mt-1 flex flex-wrap gap-2 text-sm text-muted-foreground">
          <span className="rounded-md border border-border px-2 py-1 flex items-center gap-1">
            <HugeiconsIcon
              className="w-4 h-4"
