  ...
  return (
    <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:gap-6">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-2">
        ...
        <p className="text-lg text-muted-foreground sm:text-[1.15rem] sm:leading-tight">{experience.roleTitle}</p>
        <p className="text-lg text-muted-foreground sm:text-[0.9rem] sm:leading-tight">{experience.isAnonymous ? "Anonymous" : "vivek"}</p>
