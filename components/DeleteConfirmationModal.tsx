  ...
  return (
    <>
      <button
        ...
        className="min-h-10 flex items-center justify-center gap-1 flex-1 rounded-md border border-destructive/40 px-3 py-2 text-sm font-medium text-destructive transition-colors hover:bg-destructive/5 focus:outline-none focus:ring-2 focus:ring-destructive/20 sm:w-auto"
      >
        <HugeiconsIcon
          icon={Delete02Icon}
          size="100%"
